...
- in src/utils/MkdSDK.jsx implement Line 17 // Done
- in src/utils/MkdSDK.jsx implement Line 91 // Done
- in src/pages/AdminLoginPage.jsx implement Line 30 // Done
- once login successful, call snackbar component to show logged in toast. DONT use 3rd party library // Done
- in src/authContext.jsx implement 16 // Done
- in src/authContext.jsx implement 40 to check if token still valid // Done
- There's a bug that it flickers Page Not Found // Done
- once logged in go to dashboard page like figma file
  https://www.figma.com/file/veiESwD61KJBa7BpEHtbdl/react-task-2?node-id=1086%3A15525 // Done
...
- Please READ SDK file and reuse code when you can. DO NOT REINVENT THE WHEEL. // Done
